---
title: "Distinct material culture signatures suggest that two Caddo communities shared common trading relationships"
author:
...
Nodule size and mechanical flaking properties have routinely been advanced to account for morphological differences among sites and assemblages in areas rich in raw material/s. However, in instances where lithic raw material of a particular size was scarce, did traders from different sites interact with common brokers from regions associated with lithic abundance? Gahagan bifaces are among those implements most diagnostic of Formative/Early Caddo material culture assemblages; however, due to a lack of local production evidence, it is also widely accepted that Gahagan bifaces were not made by the Caddo. This study asks whether Caddo traders from Gahagan Mound and Mounds Plantation may have engaged in commerce with brokers from common extralocal communities. Results demonstrate that two distinct raw materials were used in the production of Gahagan bifaces. Thus, it is posited that Gahagan bifaces from Caddo mortuary contexts at Gahagan Mound and Mounds Plantation were acquired through trade and/or exchange with two or more producers operating under similar cultural constraints, who manufactured Gahagan bifaces distinct in color, geochemistry, and shape.
...
The PCA illustrates 59.32 percent of the variation in the sample among PC1 (42.81 percent) and PC2 (16.51 percent). The perMANOVA demonstrated that elemental values differ significantly by raw material color groups (_permutations = 10,000; **Pr(>F) = 0.018**_).
