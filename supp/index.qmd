...
Archaeologists regularly assume that the physical properties of lithic raw materials are a determining factor in the morphology of stone tools; although, some have argued that this assumption warrants regular testing. Raw material nodule size and mechanical flaking properties are routinely advanced to account for morphological differences that occur between sites and assemblages. Color is often used as the determining characteristic of lithic raw material, and new analytical tools allow for an objective analysis of raw material color. Two raw material color groups were identified for Gahagan bifaces from the Gahagan Mound and Mounds Plantation sites in the American Southeast. This study asks whether Gahagan biface geochemistry and morphology differs as a function of raw material color group. Findings demonstrate that Gahagan bifaces differ significantly in geochemistry, but not morphology, by raw material color group. Thus, this study yields support for the argument that lithic raw material properties differ between raw material color groups, while supporting the argument against the assumption of lithic morphology as a function of raw material. Given these findings, paired with the absence of local production evidence, it is posited that Gahagan bifaces from Caddo mortuary contexts at Gahagan Mound and Mounds Plantation were acquired through trade and/or exchange with producers who operated under a similar mental template, and who manufactured the Gahagan bifaces using raw materials distinct in both color and geochemistry.
...
The PCA illustrates 59.32 percent of the variation in the sample among PC1 (42.81 percent) and PC2 (16.51 percent). The perMANOVA demonstrated that elemental values differ significantly by raw material color groups (permutations = 10,000; Pr(>F) = 0.0253).

  -   Raw material color groups _**differ significantly**_ in geochemistry
...
To assess whether `shape` and `size` differs by `ColorGroup`, Procrustes ANOVAs [@RN1749] were run that enlist effect-sizes (zscores) computed as standard deviates of the generated sampling distributions [@RN1756]. A residual randomization permutation procedure (RRPP; n = 10,000 permutations) was used for all Procrustes ANOVAs [@RN1655;@RN11775], which has higher statistical power and a greater ability to identify patterns in the data should they be present [@RN1719]. An analysis of morphological disparity was used to identify potential differences in shape and size diversity between sites [@RN11107;@RN7041;@RN5694].
  ...
  -   Neither shape nor size of Gahagan bifaces differs by raw material color groups
