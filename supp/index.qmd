...
```{r figmap, out.width = "100%", dpi = 300, echo=FALSE, warning=FALSE, fig.cap="Location of Mounds Plantation and Gahagan Mound, local boundaries of the Red River basin, and geographic extent of ancestral Caddo area."}
...
```
  ...
  -   The size of Gahagan biface included in Caddo burials at Mounds Plantation and Gahagan Mound is consistent
