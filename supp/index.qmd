---
title: "Diagnostic biface acquisition through trade with distinct extralocal communities of practice: A case study from the American Southeast"
author:
...
Gahagan bifaces from Caddo mortuary contexts at Gahagan Mound and Mounds Plantation are thought to have been products of trade and/or exchange due to a lack of evidence for local manufacture and the absence of locally-available raw material sources of similar size and quality. The results of the quantitative analysis of raw material color were used to assign bifaces to two color groups; one characterized as being more brown in color, and the other, more gray. The analyses of geochemistry and morphology demonstrate significant differences between color groups. Thus, findings suggest that Gahagan biface shape was conditioned by raw material color. The implication, then, is that Caddo traders acquired Gahagan bifaces from two distinct communities of practice, where local raw material and production differences resulted in Gahagan bifaces that were unique in color, geochemistry, and shape.
