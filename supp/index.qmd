...
Archaeologists regularly assume that the physical properties of lithic raw materials are a determining factor in the morphology of stone tools; although, some have argued that this assumption warrants regular testing. Raw material nodule size and mechanical flaking properties are routinely advanced to account for morphological differences that occur between sites and assemblages. Lithic raw material assignments often use color as the determining characteristic, and new analytical tools allow for an objective analysis of raw material color. Two raw material color groups---both assumed to be Edwards Formation cherts---were identified for Gahagan bifaces from the Gahagan Mound and Mounds Plantation sites in the American Southeast. This study asks whether the geochemistry and morphology of Gahagan bifaces differs as a function of raw material color group. Findings demonstrate that Gahagan bifaces differ significantly in geochemistry, but not morphology, by raw material color group. Thus, this study yields support for the argument that lithic raw material properties differ between raw material color groups, and added support for the argument against the general assumption of biface morphology as a function of raw material. Given these findings, paired with the absence of local production evidence, it is posited that Gahagan bifaces from Caddo mortuary contexts at Gahagan Mound and Mounds Plantation were acquired through trade and/or exchange with producers who operated under a similar mental template, and who manufactured the Gahagan bifaces using raw materials distinct in both color and geochemistry.
