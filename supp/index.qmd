...
Nodule size and mechanical flaking properties have routinely been advanced to account for morphological differences between sites and assemblages that occur in areas rich in raw material. However, in instances where lithic raw material was scarce, did Caddo traders from different sites interact with brokers from common extralocal communities associated with lithic abundance? Gahagan bifaces are among those implements most diagnostic of Formative/Early Caddo material culture assemblages; however, due to a lack of local production evidence, it is also widely accepted that Gahagan bifaces were not produced by the Caddo. This study asks whether Caddo traders from Gahagan Mound and Mounds Plantation may have engaged in commerce with brokers from common extralocal communities. Results demonstrate that two distinct raw materials were used in the production of Gahagan bifaces. Thus, it is posited that Gahagan bifaces from Caddo mortuary contexts at Gahagan Mound and Mounds Plantation were acquired through trade with two or more producers operating under similar cultural constraints, who manufactured Gahagan bifaces that were distinct in color, geochemistry, and shape.
...
knitr::include_graphics('img/cielab.png')
```
