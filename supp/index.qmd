...
Elemental data were imported to R [@RN8584] for the production of boxplots, a principal components analysis (PCA), and a permutational multivariate analysis of variance (perMANOVA) to test whether the raw material used in the production of Gahagan bifaces differs between sites.

```{r figsite, out.width = "100%", dpi = 300, echo=FALSE, warning=FALSE, fig.cap="Composite image illustrating the plot of first two principal components by site using a correlation matrix, illustrating 66.7 percent of cumulative shape variation."}
...
```{r figpcashape, out.width = "100%", dpi = 300, echo=FALSE, warning=FALSE, fig.cap="PCA summarizing shape variation in Gahagan bifaces from Mounds Plantation (orange) and Gahagan Mound (gray)."}
...
```{r fig2BPLS, out.width = "100%", dpi = 300, echo=FALSE, warning=FALSE, fig.cap="Plot of two-block partial least-squares analysis for significant correlation expressed between Gahagan biface shape variables (Block 1) and elemental data (Block 2)."}
