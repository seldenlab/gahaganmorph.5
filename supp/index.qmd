...
Nodule size and mechanical flaking properties have routinely been advanced to account for morphological differences between sites and assemblages that occur in areas where raw material is abundant. However, in instances where lithic raw materials---larger nodules in particular---were scarce, did traders from different sites interact with brokers from common extralocal communities to acquire large bifaces that generally conformed to their design constraints? Gahagan bifaces are among those implements diagnostic of Formative/Early Caddo material culture (CE 800 - 1250); although, due to a lack of local production evidence, it is also widely accepted that Gahagan bifaces were not produced by the Caddo. This study asks whether Caddo traders from Gahagan Mound and Mounds Plantation may have engaged in commerce with brokers from common extralocal communities to acquire Gahagan bifaces. Results demonstrate Gahagan biface geochemistry and shape to be distinct based on color group assignment, but neither biface shape nor size was correlated with geochemistry. Thus, it is posited that Gahagan bifaces from Caddo mortuary contexts at Gahagan Mound and Mounds Plantation were acquired through trade with two or more non-local communities, who produced Gahagan bifaces distinct in raw material color, geochemistry, and shape. These findings also support the interpretation that, like the elliptical bifaces from Caddo sites, Gahagan biface shape was not conditioned by nodule size or mechanical flaking properties, but by raw material color.
